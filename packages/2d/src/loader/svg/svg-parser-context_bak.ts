...
import { SvgPortBak } from "./svg-port-bak";
...
export class SvgParserContextBak {

    private constructor(
        private readonly root: SVGSVGElement,
        private readonly port: SvgPortBak,
    ...
    static newInstance(svg: SVGSVGElement, port: SvgPortBak): SvgParserContextBak {
        ...
        return new SvgParserContextBak(svg, port, vb.x, vb.height + vb.y, parameters, new Map(), new Map(), new Map());
    }
    ...
    withChild(el: SVGElement): SvgParserContextBak {
        const ret = new SvgParserContextBak(this.root, this.port, this.viewboxLeft, this.viewboxBottom, { ...this.currentParameters }, this.paintStyles, this.linearGradients, this.radialGradients);
        ret.calculateAttributes(el);
        return ret;
    }

    withChildSvg(svg: SVGSVGElement): SvgParserContextBak {
        const vb = svg.viewBox.baseVal;
        const ret = new SvgParserContextBak(this.root, this.port, vb.x, vb.height + vb.y, { ...this.currentParameters }, this.paintStyles, this.linearGradients, this.radialGradients);
